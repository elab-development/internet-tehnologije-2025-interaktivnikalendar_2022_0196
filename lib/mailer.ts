...
//provera da li su podaci postavljeni u .env
...
//transporter objekat, koristi se za slanje svih emailova u projektu
...
//podaci potrebni za slanje mejla
...
// funkcija za slanje email notifikacije za dogadjaj
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #fff;">
      ...
      <p style="color: #555; font-size: 16px;">
        Zdravo <strong>${data.toName}</strong>,
      </p>
      <p style="color: #555; font-size: 16px;">
        Podsetnik: događaj počinje za <strong>${data.minutesBefore} minuta</strong>.
      </p>
